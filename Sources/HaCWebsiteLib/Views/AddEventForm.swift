    ...
    return Page(
      ...
      content: Fragment(
        El.Div[Attr.className => "AddEventPage__mainContainer"].containing(
          ...
          El.Input[Attr.type => "number", Attr.id => "latitude", Attr.className => "AddEventPage__formInput"],
          El.Div[Attr.className => "AddEventPage__inputLabel"].containing("longitude"),
          El.Input[Attr.type => "number", Attr.id => "longitude", Attr.className => "AddEventPage__formInput"],
